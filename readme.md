...
- [Repository disclosure](#repository-disclosure)
...
- [Blogs](https://github.com/Mwaseemzakir/awesome-dotnet-resources/blob/main/docs/blogs.md) - Articles and tutorials by well-known .NET writers.
...
Some lists tag entries so you can pick faster: 🟢 Beginner · 🟡 Intermediate · 🔴 Advanced. 🆓 Free · 💲 Paid. An asterisk (`*`) marks an affiliate link.

## About the author

I am Muhammad Waseem from Pakistan, a Senior Software Engineer (.NET) and a tech enthusiast. I love to learn new things and share my knowledge with others.

I mostly share on [LinkedIn](https://www.linkedin.com/in/mwaseemzakir/), [Twitter](https://twitter.com/mwaseemzakir), and [Medium](https://medium.com/@mwaseemzakir). For a weekly dose of .NET content, subscribe to my [newsletter](https://waseemzakir.substack.com/).
...
Found a great resource or a broken link? Contributions are welcome - see the [contribution guidelines](https://github.com/Mwaseemzakir/awesome-dotnet-resources/blob/main/CONTRIBUTING.md). Every pull request is automatically checked for dead links.

## Repository disclosure

**Inclusion.** This list is open to contributions; individuals, sites, courses, and blogs not currently listed may be added in the future. The author welcomes any addition that is valuable to the .NET community.

**Purpose.** This repository supports the .NET community, and the author intends to continuously expand and enhance its content.

**Affiliate links.** Links marked with an asterisk (`*`) are affiliate links. If you click one and make a purchase, the author may earn a commission at no additional cost to you.

This work is dedicated to the public domain under [CC0 1.0](https://github.com/Mwaseemzakir/awesome-dotnet-resources/blob/main/LICENSE).
